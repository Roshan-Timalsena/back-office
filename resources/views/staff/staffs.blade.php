                ...
                @forelse ($staffs as $staff)
                    @can('view', $staff)
                        <tr>
                            ...
                            <td class="down">{{ $staff->user_type }}</td>
                            <td class="down">@cannot('update', $staff) <p class="text-danger">Not Allowed</p> @endcannot
                                @can('update', $staff)<a href="#">Edit</a>@endcan &nbsp; @can('remove', $staff)<a
                                href="#">Delete</a>@endcan</td>
                    </tr>
                @endcan
                @empty
                    <tr>
